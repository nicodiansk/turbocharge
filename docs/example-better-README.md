<p align="center">
  <img src="assets/hero-banner.svg" alt="turbocharge — one plugin, one pipeline, no conflicts" width="100%">
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/skills-8-3b82f6.svg?style=flat-square&labelColor=0d1117" alt="8 Skills">
...
**Turbocharge replaces all of it** with a single opinionated pipeline: 8 skills, 6 agents, 2 hooks. One system to install, nothing to maintain.
...
<!-- GIF placeholder: record a 20s demo of brainstorm → story flow -->
<!-- <p align="center"><img src="assets/demo.gif" alt="turbocharge demo" width="700"></p> -->
...
**Multi-track mode** — independent tasks can run in parallel with coordinated builders. Requires [Agent Teams](https://docs.anthropic.com) (experimental):
...
Turbocharge replaces scattered config. Remove anything that overlaps:
