#!/usr/bin/env bash
# ABOUTME: Test runner for Claude Code skills
# ABOUTME: Invokes Claude Code CLI and verifies skill behavior with timeout and reporting
set -euo pipefail
...
echo "========================================"
echo " Turbocharge Skills Test Suite"
echo "========================================"
echo ""
