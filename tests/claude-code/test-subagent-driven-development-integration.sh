#!/usr/bin/env bash
# ABOUTME: Integration test for subagent-driven-development workflow
# ABOUTME: Executes a real plan and verifies end-to-end skill behavior
set -euo pipefail
...
if grep -q '"name":"Skill".*"skill":"turbocharge:subagent-driven-development"' "$SESSION_FILE"; then
